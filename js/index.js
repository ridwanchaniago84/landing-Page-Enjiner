const headLoader = () => {
                ...
                <div class="col-md-12">
                    <div class="d-flex justify-content-between">
                        <div class="align-self-center header-col-left">
                            ...
                            <div id="logo">
                                <a href="index.html">
                                    <img alt="Logo Enjiner" src="images/logo/enginerid_2_color.png" />
                                </a>
                            </div>
                            <!-- logo close -->
                        </div>
                        <div class="align-self-center ml-auto header-col-mid">
                            ...
                            <ul id="mainmenu">
                                ...
                                <li>
                                    <a href="services-pricing.html">Service & Pricing</a>
                                </li>
                                <li>
    ...
    elementHeader.innerHTML = headerInner;
}
...
const footerLoader = () => {
    ...
    const FooterContent = `
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <div class="widget">
                        <a href="index.html"><img alt="Logo Enjiner" class="logo" src="images/logo/enginerid_2_color.png"></a>
            ...
            <div class="row">
                <div class="col-md-6 sm-text-center mb-sm-30">
                    <div class="mt10">&copy; Copyright 2020 - Enjiner.id</div>
                </div>
    ...
    elementFooter.innerHTML = FooterContent;
}
